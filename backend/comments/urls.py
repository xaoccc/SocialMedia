...
from .views import AddNewComment, ShowAllComments, LikeComment,  EditComment, ReplyCreateView, ShowAllReplies, EditReply, DeleteView
...
urlpatterns = [
    ...
    path("delete/", DeleteView.as_view(), name="comment_delete"),   
